...
{Fore.GREEN}4.{Style.RESET_ALL} Mac OS
	...
	if oss == '1':
		os.system('pkg update && pkg upgrade && pkg install pip && pkg install python3-pip && pip install colorama requests fake_useragent')
		from core import android
	elif oss == '2':
		os.system('apt update && apt upgrade && apt install pip && pkg install python3-pip && pip install colorama requests fake_useragent')
		from core import windows
	elif oss == '3':
		os.system('apt update && apt upgrade && apt install pip && pkg install python3-pip && pip install colorama requests fake_useragent')
		from core import unix
	elif oss == '4':
		os.system('brew update && brew upgrade && apt install pip && pkg install python3-pip && pip install colorama requests fake_useragent')
