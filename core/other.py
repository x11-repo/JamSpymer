...
╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯{sr}''')
	...
	new = input(f'''{r}╭━━━{g}[x11repo | {r1}Jam{r2}Spymer{g}]
{r}┃
{r}╰━━━[{sr}{times}{r}]━━━> {sr}''')
	...
	if new == '1':
		...
		if aaasd == 'y':
			os.system('cd && rm -rf JamSpymer && git clone https://github.com/x11-repo/jamspymer && cd JamSpymer && python3 JamSpymer.py')
		else:
			main()
	elif new == '6':
		print('Если у Вас возникли проблемы с бомбером, вы можете задать любой вопрос в нашем телеграм чате - https://t.me/jamsfam')
		time.sleep(3)
		main()
	elif new == '7':
...
os.system("cls")
os.system("clear")
print(Style.RESET_ALL+f"""Перед запуском введите {g}код аутентификации{sr}.
